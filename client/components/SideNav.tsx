...
export const SideNav = () => {
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-background shadow-2xl border-border p-6 h-[100dvh] sticky top-0">
      {/* Logo */}
      ...
      <button
        ...
        className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-muted-foreground hover:text-foreground hover:bg-black/5 border border-transparent transition-all group"
      >
