        ...
        <div className="px-6 md:px-8 pt-4 md:pt-6 pb-4 md:pb-6 border-b border-white/10">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-lg pl-10 pr-4 py-2.5 md:py-3 text-sm md:text-base text-white placeholder-neutral-500 focus:outline-none focus:ring-1 focus:ring-amber-500/50 focus:border-primary/50 transition-all"
            />
          </div>
