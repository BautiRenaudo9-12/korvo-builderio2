  ...
  return (
    <div className="w-full px-6 md:px-8 pt-4 md:pt-8 pb-24 md:pb-8">
      ...
      <div className="mb-6 md:mb-8">
        <h2 className="text-2xl md:text-4xl font-bold text-foreground mb-2 md:mb-3">Explorar Tiendas</h2>
      ...
      <div className="mt-4 md:hidden glass-panel p-4 rounded-xl border border-border">
