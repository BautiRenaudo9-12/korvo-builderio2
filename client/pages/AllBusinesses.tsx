            ...
            <div className=" rounded-lg p-4  bg-white shadow-xl space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg px-3 py-2 text-foreground placeholder-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary/50 focus:border-primary/50"
