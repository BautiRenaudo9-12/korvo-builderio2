    ...
    <div className="px-6 md:px-8 pt-4 md:pt-8 pb-24">
      ...
      <div className="relative mb-6 md:mb-8">
        ...
        <input
          ...
          className="w-full shadow-sm rounded-lg pl-10 pr-4 py-2.5 md:py-3 text-sm md:text-base  placeholder-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary/50 focus:border-primary/50 transition-all text-foreground"
          style={{
